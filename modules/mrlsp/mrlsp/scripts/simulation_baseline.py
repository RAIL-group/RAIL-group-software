...
def navigate_unknown(args, termination=any, num_robots=2, do_plot=True):
    ...
    with builder(args.unity_path) as unity_bridge:
        ...
        planner = mrlsp.planners.BaselineLSA(robots, goal_pose, args)
    ...
    cost_file = Path(args.save_dir) / f'planner_baseline_{args.map_type}_cost_{args.current_seed}_r{num_robots}.txt'
